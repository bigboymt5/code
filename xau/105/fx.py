...
2. Momentum strength : Indicate a percentage between 50-100% (Strong momentum must be above 76%)
...
2. Momentum strength: [Percentage]%
    ...
    try:
            ...
            messages=[
                {
                    ...
                    The JSON should be in this exact format:
                    {
                        ...
                        "momentum_strength": number between 50-100,
        ...
        try:
            ...
            key_mapping = {
                ...
                'momentum_strength': 'confidence_level',  # 모멘텀 강도를 confidence_level로 매핑
                'momentum': 'confidence_level',           # 짧은 버전도 추가
